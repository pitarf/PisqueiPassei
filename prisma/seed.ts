 ...
 * Popula a taxonomia estrita do edital sem alterar nomes ou inventar tópicos.
 */
async function main() {
  console.log("🌱 Iniciando o Seed Oficial da Transpetro 2026.3...");

  // 1. Criar ou Atualizar Usuário Principal (Rafael)
  const user = await prisma.user.upsert({
    ...
    create: {
      ...
      targetScore: 47, // Meta inicial: 47/60 pontos
      dailyStudyHours: 2.5,
      currentStreak: 1,
      xp: 150,
  ...
  // 2. Configurações de Sistema (SEO e Plataforma)
  ...
  await prisma.systemSetting.upsert({
    where: { key: "examDate" },
    update: {
      value: "2026-12-06T13:00:00.000Z",
    },
    create: {
      key: "examDate",
      value: "2026-12-06T13:00:00.000Z",
  ...
  const subjectsData = [
    ...
    },
    {
      ...
      order: 2,
      topics: [
        { code: "1", title: "Conjuntos numéricos", order: 1 },
        { code: "2", title: "Razão e proporção", order: 2 },
        { code: "3", title: "Regra de três simples e composta", order: 3 },
        { code: "4", title: "Porcentagem", order: 4 },
        { code: "5", title: "Relações e funções", order: 5 },
        { code: "6", title: "Equações", order: 6 },
        { code: "7", title: "Análise combinatória", order: 7 },
        { code: "8", title: "Probabilidade básica", order: 8 },
        { code: "9", title: "Estatística básica", order: 9 },
        { code: "10", title: "Matemática financeira", order: 10 },
        { code: "11", title: "Geometria plana", order: 11 },
        { code: "12", title: "Geometria espacial", order: 12 },
      ],
    },
    {
    ...
    },
    {
      ...
      topics: [
        {
          code: "3.1",
          title: "Decreto nº 2.745, de 24 de agosto de 1998",
          description: "Procedimento licitatório simplificado da Petróleo Brasileiro S/A.",
          officialSource: "Decreto Presidencial nº 2.745/1998",
          order: 1,
        },
        {
          code: "3.2",
          title: "Artigos 28 a 91 da Lei nº 13.303, de 30 de junho de 2016",
          description: "Estatuto jurídico da empresa pública, da sociedade de economia mista e de suas subsidiárias.",
          officialSource: "Lei 13.303/2016 (Arts. 28 a 91)",
          order: 2,
        },
        {
          code: "3.3",
          title: "Artigos 42 a 49 da Lei Complementar nº 123, de 14 de dezembro de 2006",
          description: "Estatuto Nacional da Microempresa e da Empresa de Pequeno Porte aplicado a compras públicas.",
          officialSource: "LC 123/2006 (Arts. 42 a 49)",
          order: 3,
        },
        {
          code: "3.4",
          ...
          officialSource: "Lei 14.133/2021",
          order: 4,
        },
        {
          code: "3.5",
          title: "Regulamento de Licitações e Contratos da Transpetro",
          description: "Regulamento interno da Transpetro (RLCP).",
          officialSource: "Regulamento Transpetro",
          order: 5,
        },
        {
          code: "3.6",
          title: "Lei Geral de Proteção de Dados Pessoais (LGPD) aplicada a contratações públicas",
          description: "Lei nº 13.709/2018 aplicada no contexto de licitações e contratos.",
          officialSource: "Lei 13.709/2018",
          order: 6,
        },
      ],
    },
      ...
      if (!existingTopic) {
        existingTopic = await prisma.topic.create({
          data: {
            ...
            code: top.code,
            title: top.title,
            description: (top as { description?: string }).description || null,
            officialSource: (top as { officialSource?: string }).officialSource || null,
            order: top.order,
          },
        });
      }

      // Inicializar progresso do usuário no tópico se não existir
